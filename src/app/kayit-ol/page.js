...
export default function SignUpPage() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      setTimeout(() => {
        router.replace(`/giris-yap?next=${encodeURIComponent(nextUrl)}`);
      }, 1000);
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm text-white/60">
              ...
              <Link href={`/giris-yap?next=${encodeURIComponent(nextUrl)}`} className="font-semibold text-[#ffc451] hover:underline">
                Giriş Yapın.
              </Link>
            </p>
          </div>
